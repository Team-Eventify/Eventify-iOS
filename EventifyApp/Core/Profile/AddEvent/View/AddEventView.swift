...
struct AddEventView: View {
	...
	init(
		...
		_categoriesVM = StateObject(
			wrappedValue: categoriesVM ?? PersonalCategoriesViewModel()
		)
	}
	...
	private var eventNameSection: some View {
		VStack(alignment: .leading) {
			...
			EventifyTextField(text: $viewModel.name, placeholder: "Введите название", isSecure: false)
		}
	}
	...
	private var publishButton: some View {
		EventifyButton(title: "Опубликовать ивент", isLoading: false, isDisabled: false) {
