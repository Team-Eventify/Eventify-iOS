...
final class UserDefaultsManager {
	...
	func setFcmToken(_ fcmToken: String) {
		defaults.set(fcmToken, forKey: UserDefaultsKeys.fcmToken.rawValue)
	}

	func getFcmToken() -> String? {
		return defaults.string(forKey: UserDefaultsKeys.fcmToken.rawValue)
	}

	func removeFcmToken() {
		defaults.removeObject(forKey: UserDefaultsKeys.fcmToken.rawValue)
	}
